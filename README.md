## KALKULATOR/ APLIKASI PENGHITUNG DEPRESIASI SUATU AKTIVA TETAP PER PERIODE MENGGUNAKAN PYTHON

```
#membuat garis sebanyak 40x
print("="*40)
print("    Aplikasi Penghitung Depresiasi")
print("\tStraight Line Method")
print("="*40)

#memasukkan inputan user dengan tipe datanya
harga           = float(input("\nHarga Perolehan    = "))
...
#perulangan untuk menghitung depresiasi sesuai tahun yang diinputkan user
